        ...
        >
            <Tabs.Screen
                ...
                options={{
                    ...
                    headerShown: false,
                    tabBarIcon: ({ focused }) => (
                        <TabIcon icon={icons.home} focused={focused} title="Главная" />
                    )
                }}
            /><Tabs.Screen
                name="explore"
                options={{
                    ...
                    headerShown: false,
                    tabBarIcon: ({ focused }) => (
                        <TabIcon icon={icons.search} focused={focused} title="Поиск" />
                    )
                }}
            /><Tabs.Screen
                name="profile"
                options={{
                    ...
                    headerShown: false,
                    tabBarIcon: ({ focused }) => (
                        <TabIcon icon={icons.person} focused={focused} title="Профиль" />
                    )
                }}
            />
        </Tabs>
